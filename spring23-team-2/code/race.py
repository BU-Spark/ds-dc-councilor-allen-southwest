...
Original file is located at
    https://colab.research.google.com/drive/122Aq45aN0GGxa6V0ZBeTz7g9h2MlJYH0
"""
...
link ='https://drive.google.com/file/d/1TZCCZm8eGXdbwZmipdFBmlPKK9udY-WW/view?usp=sharing'
import pandas as pd
...
downloaded.GetContentFile('race ACSST5Y2021.S2502-2023-03-19T183022.csv') 

df1 = pd.read_csv('race ACSST5Y2021.S2502-2023-03-19T183022.csv')

# Remove all columns containing "Margin" in the column name
df1 = df1.loc[:, ~df1.columns.str.contains('Margin')]

# Save the modified DataFrame to a new CSV file
df1.to_csv('race 2021 new_file.csv', index=False)

import pandas as pd
import matplotlib.pyplot as plt
import numpy as np
race_2021_df = pd.read_csv("race 2021 new_file.csv")

# Analysis of mean income
race_2021_df.head(12)

link ='https://drive.google.com/file/d/1t3-CwXy-J0w39DepKqLjyBTv8RGJnLqP/view?usp=share_link'
import pandas as pd
...
downloaded.GetContentFile('race ACSST5Y2019.S2502-2023-03-19T183035.csv') 

df3 = pd.read_csv('race ACSST5Y2019.S2502-2023-03-19T183035.csv')

# Remove all columns containing "Margin" in the column name
df3 = df3.loc[:, ~df3.columns.str.contains('Margin')]

# Save the modified DataFrame to a new CSV file
df3.to_csv('race 2019 new_file.csv', index=False)

import pandas as pd
import matplotlib.pyplot as plt
import numpy as np
finance_char_df = pd.read_csv("race 2019 new_file.csv")

# Analysis of mean income
finance_char_df.head(12)

link ='https://drive.google.com/file/d/12k-iVK_vgkSuNVhH04ObRvwRu5xiYKgy/view?usp=share_link'
import pandas as pd
...
downloaded.GetContentFile('race ACSST5Y2018.S2502-2023-03-19T183038.csv') 

df4 = pd.read_csv('race ACSST5Y2018.S2502-2023-03-19T183038.csv')

# Remove all columns containing "Margin" in the column name
df4 = df4.loc[:, ~df4.columns.str.contains('Margin')]

# Save the modified DataFrame to a new CSV file
df4.to_csv('race 2018 new_file.csv', index=False)

import pandas as pd
import matplotlib.pyplot as plt
import numpy as np
race_2018_df = pd.read_csv("race 2018 new_file.csv")

# Analysis of mean income
race_2018_df.head(12)

link ='https://drive.google.com/file/d/1VfOWERE9rd_KgrzvocNjpf3va-eqzXx0/view?usp=share_link'
import pandas as pd
...
downloaded.GetContentFile('race ACSST5Y2017.S2502-2023-03-19T183043.csv') 

df5 = pd.read_csv('race ACSST5Y2017.S2502-2023-03-19T183043.csv')

# Remove all columns containing "Margin" in the column name
df5 = df5.loc[:, ~df5.columns.str.contains('Margin')]

# Save the modified DataFrame to a new CSV file
df5.to_csv('race 2017 new_file.csv', index=False)

import pandas as pd
import matplotlib.pyplot as plt
import numpy as np
race_2017_df = pd.read_csv("race 2017 new_file.csv")

# Analysis of mean income
race_2017_df.head(12)

link ='https://drive.google.com/file/d/19-45VlNCx2M6rDgeOshXq53KSgZRowtC/view?usp=share_link'
import pandas as pd
...
downloaded.GetContentFile('race ACSST5Y2020.S2502-2023-03-19T183026.csv') 

df2 = pd.read_csv('race ACSST5Y2020.S2502-2023-03-19T183026.csv')

# Remove all columns containing "Margin" in the column name
df2 = df2.loc[:, ~df2.columns.str.contains('Margin')]

# Save the modified DataFrame to a new CSV file
df2.to_csv('race 2020 new_file.csv', index=False)

import pandas as pd
import matplotlib.pyplot as plt
import numpy as np
race_2020_df = pd.read_csv("race 2020 new_file.csv")

# Analysis of mean income
race_2020_df.head(12)

owner105_col = 'Census Tract 105, District of Columbia, District of Columbia!!Owner-occupied housing units!!Estimate'
renter105_col = 'Census Tract 105, District of Columbia, District of Columbia!!Renter-occupied housing units!!Estimate'

df1_105_df = df1[[owner105_col, renter105_col]].iloc[3: , :]

df1_105_df[owner105_col]=df1_105_df[owner105_col].replace(regex=[r'\D+'], value="")
df1_105_df[renter105_col]=df1_105_df[renter105_col].replace(regex=[r'\D+'], value="")

#2021
df1_105_df = df1_105_df.dropna(subset=[owner105_col, renter105_col])

df1_105_df[owner105_col] = df1_105_df[owner105_col].astype(int)
df1_105_df[renter105_col] = df1_105_df[renter105_col].astype(int)
df1_105_df.head(9)

#2020
df2_105_df = df2[[owner105_col, renter105_col]].iloc[3: , :]

df2_105_df[owner105_col] = df2_105_df[owner105_col].replace(regex=[r'\D+'], value="")
df2_105_df[renter105_col] = df2_105_df[renter105_col].replace(regex=[r'\D+'], value="")

df2_105_df = df2_105_df.dropna(subset=[owner105_col, renter105_col])

df2_105_df[owner105_col] = df2_105_df[owner105_col].astype(int)
df2_105_df[renter105_col] = df2_105_df[renter105_col].astype(int)
df2_105_df.head(9)

#2019
df3_105_df = df3[[owner105_col, renter105_col]].iloc[3: , :]

df3_105_df[owner105_col] = df3_105_df[owner105_col].replace(regex=[r'\D+'], value="")
df3_105_df[renter105_col] = df3_105_df[renter105_col].replace(regex=[r'\D+'], value="")

df3_105_df = df3_105_df.dropna(subset=[owner105_col, renter105_col])

df3_105_df[owner105_col] = df3_105_df[owner105_col].astype(int)
df3_105_df[renter105_col] = df3_105_df[renter105_col].astype(int)
df3_105_df.head(9)

#2018
df4_105_df = df4[[owner105_col, renter105_col]].iloc[3: , :]

df4_105_df[owner105_col] = df4_105_df[owner105_col].replace(regex=[r'\D+'], value="")
df4_105_df[renter105_col] = df4_105_df[renter105_col].replace(regex=[r'\D+'], value="")

df4_105_df = df4_105_df.dropna(subset=[owner105_col, renter105_col])

df4_105_df[owner105_col] = df4_105_df[owner105_col].astype(int)
df4_105_df[renter105_col] = df4_105_df[renter105_col].astype(int)
df4_105_df.head(9)

#2017
df5_105_df = df5[[owner105_col, renter105_col]].iloc[3: , :]

df5_105_df[owner105_col] = df5_105_df[owner105_col].replace(regex=[r'\D+'], value="")
df5_105_df[renter105_col] = df5_105_df[renter105_col].replace(regex=[r'\D+'], value="")

df5_105_df = df5_105_df.dropna(subset=[owner105_col, renter105_col])

df5_105_df[owner105_col] = df5_105_df[owner105_col].astype(int)
df5_105_df[renter105_col] = df5_105_df[renter105_col].astype(int)
df5_105_df.head(9)

df1_105_list = df1_105_df.values.tolist()

df2_105_list = df2_105_df.values.tolist()

df3_105_list = df3_105_df.values.tolist()

df4_105_list = df4_105_df.values.tolist()

df5_105_list = df5_105_df.values.tolist()
#df1_64_list = [[row[i] for i in range(1, len(row))] for row in df1_64_list]
print(df1_105_list[0][0])
print(df2_105_list[0][0])
print(df3_105_list[0][0])
print(df4_105_list[0][0])
print(df5_105_list[0][0])

print(df1_105_list[0][1])
print(df2_105_list[0][1])
print(df3_105_list[0][1])
print(df4_105_list[0][1])
print(df5_105_list[0][1])
...
white = []
white.append(df5_105_list[0][0]) 

white.append(df4_105_list[0][0])

white.append(df3_105_list[0][0])

white.append(df2_105_list[0][0])

white.append(df1_105_list[0][0])
...
alone.append(df5_105_list[8][0])

alone.append(df4_105_list[8][0])

alone.append(df3_105_list[8][0])

alone.append(df2_105_list[8][0])

alone.append(df1_105_list[8][0])
...
ax.set_title('Owner-occupied Units by Race, Data from Cencus Tract 105')
ax.set_xlabel('Year')
ax.set_ylabel('Units')
...
years = [2017, 2018, 2019, 2020 , 2021]
white = []
white.append(df5_105_list[0][1]) 

white.append(df4_105_list[0][1])

white.append(df3_105_list[0][1])

white.append(df2_105_list[0][1])

white.append(df1_105_list[0][1])
#[df5_64_list[0][1],df4_64_list[0][1],df3_64_list[0][1],df2_64_list[0][1],df1_64_list[0][1]],
black = []
black.append(df5_105_list[1][1])

black.append(df4_105_list[1][1])

black.append(df3_105_list[1][1])

black.append(df2_105_list[1][1])

black.append(df1_105_list[1][1])
#= [df5_64_list[0][0],df4_64_list[0][0],df3_64_list[0][0],df2_64_list[0][0],df1_64_list[0][0]],
...
alone.append(df5_105_list[8][1])

alone.append(df4_105_list[8][1])

alone.append(df3_105_list[8][1])

alone.append(df2_105_list[8][1])

alone.append(df1_105_list[8][1])
...
# Add legends, titles, axis labels, etc.
ax.set_title('Renter-occupied Units by Race, Data from Cencus Tract 105')
ax.set_xlabel('Year')
ax.set_ylabel('Units')
